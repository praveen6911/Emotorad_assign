...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://emotorad-assignment-lsss.onrender.com/api/auth/reset-password", {
        method: "POST",
      ...
      <div className="right-section">
        <div className="reset-box">
          ...
          <p className="login-text">
            Remembered your password? <span onClick={() => navigate("/")}>Sign in here</span>
          </p>
