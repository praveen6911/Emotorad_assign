...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://emotorad-assignment-lsss.onrender.com/api/auth/signup", {
        method: "POST",
      ...
      <div className={styles.rightSection}>
        <div className={styles.signupBox}>
          ...
          <p className={styles.loginText}>
            Already have an account? <Link to="/" className={styles.link}>Sign in here</Link>
          </p>
